              ...
              (const TUnfoldBinningV17 *binning,ERegMode regmode,
                EDensityMode densityMode,const char *axisSteering)
                {
                  ...
                  if(regmode==kRegModeSize) {
                    ...
                    TH1 *TUnfoldDensityV17::GetOutput(const char *histogramName,const char *histogramTitle, const char *distributionName,const char *axisSteering, Bool_t useAxisBinning) const{
