...
namespace uhh2examples {
  ...
  private:
    ...
    bool passed_gen_final,       passed_gen_final_sd;
    ...
    // for generator level
    bool passed_gen_pt_mu, passed_gen_ntopjet, passed_gen_pt_topjet, passed_gen_dr, passed_gen_mass;
    bool passed_gen_ntopjet_sd, passed_gen_pt_topjet_sd, passed_gen_dr_sd, passed_gen_mass_sd;

    bool passed_gen_pt_mu_sideband,    passed_gen_pt_topjet_sideband,    passed_gen_dr_sideband,    passed_gen_mass_sideband;
    bool passed_gen_pt_mu_sideband_sd, passed_gen_pt_topjet_sideband_sd, passed_gen_dr_sideband_sd, passed_gen_mass_sideband_sd;

    // for CHS Jets w/ and w/o SoftDrop
    bool passed_rec_pt_mu, passed_rec_ntopjet, passed_rec_pt_topjet, passed_rec_dr, passed_rec_mass;
    bool passed_rec_pt_topjet_sd, passed_rec_dr_sd, passed_rec_mass_sd;

    bool passed_rec_pt_mu_sideband,    passed_rec_pt_topjet_sideband,    passed_rec_dr_sideband,    passed_rec_mass_sideband;
    bool passed_rec_pt_mu_sideband_sd, passed_rec_pt_topjet_sideband_sd, passed_rec_dr_sideband_sd, passed_rec_mass_sideband_sd;
    ...
    bool passed_rec_pt_mu_sideband_puppi,    passed_rec_pt_topjet_sideband_puppi,    passed_rec_dr_sideband_puppi,    passed_rec_mass_sideband_puppi;
    bool passed_rec_pt_mu_sideband_puppi_sd, passed_rec_pt_topjet_sideband_puppi_sd, passed_rec_dr_sideband_puppi_sd, passed_rec_mass_sideband_puppi_sd;
    ...
    std::unique_ptr<Selection> pt_mu_gen, ntopjet2_gen, pt_topjet_gen, dr_gen, mass_gen, genmatching;
    std::unique_ptr<Selection> ntopjet2_gen_sd, pt_topjet_gen_sd, dr_gen_sd, mass_gen_sd, genmatching_sd;

    std::unique_ptr<Selection> dr_gen_sideband, dr_gen_sideband_sd, pt_topjet_gen_sideband, pt_topjet_gen_sideband_sd, pt_mu_gen_sideband;
    ...
    std::unique_ptr<Selection> pt_mu_sel, ntopjet2_sel, pt_topjet_sel, dr_sel, mass_sel;
    ...
    std::unique_ptr<Selection> dr_rec_sideband_sd, pt_topjet_rec_sideband_sd, pt_mu_rec_sideband_sd;
    ...
    std::unique_ptr<Hists> h_gen_pt_mu_sideband,    h_gen_pt_topjet_sideband,    h_gen_dr_sideband,    h_gen_mass_sideband;
    std::unique_ptr<Hists> h_gen_pt_mu_sideband_sd, h_gen_pt_topjet_sideband_sd, h_gen_dr_sideband_sd, h_gen_mass_sideband_sd;
    std::unique_ptr<Hists> h_passedgen_rec, h_passedgen_rec_sd;

    // declare CHS Jets Hists w/ and w/o SoftDroph_start
    std::unique_ptr<Hists> h_start, h_pureweight, h_sfbtag, h_muontrigger, h_muontight;
    std::unique_ptr<Hists> h_pt_mu, h_ntopjet2, h_pt_topjet, h_dr, h_mass;
    ...
    std::unique_ptr<Hists> h_rec_pt_mu_sideband_sd, h_rec_pt_topjet_sideband_sd, h_rec_dr_sideband_sd, h_rec_mass_sideband_sd;
    ...
    std::unique_ptr<Hists> h_rec_pt_mu_sideband_puppi,    h_rec_pt_topjet_sideband_puppi,    h_rec_dr_sideband_puppi,    h_rec_mass_sideband_puppi;
    std::unique_ptr<Hists> h_rec_pt_mu_sideband_puppi_sd, h_rec_pt_topjet_sideband_puppi_sd, h_rec_dr_sideband_puppi_sd, h_rec_mass_sideband_puppi_sd;
    ...
    uhh2::Event::Handle<bool> h_passed_gen, h_passed_rec;

    // declare Handles for Final Selection (generator level)
    uhh2::Event::Handle<bool> h_passed_gen_final, h_passed_gen_final_sd;
    uhh2::Event::Handle<bool> h_passed_gen_pt_mu_sideband, h_passed_gen_pt_topjet_sideband, h_passed_gen_dr_sideband, h_passed_gen_mass_sideband;
    uhh2::Event::Handle<bool> h_passed_gen_pt_mu_sideband_sd, h_passed_gen_dr_sideband_sd, h_passed_gen_mass_sideband_sd, h_passed_gen_pt_topjet_sideband_sd;
    ...
    uhh2::Event::Handle<bool> h_passed_rec_pt_mu_sideband,    h_passed_rec_pt_topjet_sideband,    h_passed_rec_dr_sideband,    h_passed_rec_mass_sideband;
    uhh2::Event::Handle<bool> h_passed_rec_pt_mu_sideband_sd, h_passed_rec_pt_topjet_sideband_sd, h_passed_rec_dr_sideband_sd, h_passed_rec_mass_sideband_sd;
    ...
    uhh2::Event::Handle<bool> h_passed_rec_pt_mu_sideband_puppi,    h_passed_rec_pt_topjet_sideband_puppi,    h_passed_rec_dr_sideband_puppi, h_passed_rec_mass_sideband_puppi;
    uhh2::Event::Handle<bool> h_passed_rec_pt_mu_sideband_puppi_sd, h_passed_rec_pt_topjet_sideband_puppi_sd, h_passed_rec_dr_sideband_puppi_sd, h_passed_rec_mass_sideband_puppi_sd;
  ...
  PostKinCutModule::PostKinCutModule(Context & ctx){
    ...
    h_passed_gen_pt_mu_sideband_sd        = ctx.declare_event_output<bool>("h_passed_gen_pt_mu_sideband_sd");
    ...
    h_passed_rec_pt_mu_sideband_sd           = ctx.declare_event_output<bool>("h_passed_rec_pt_mu_sideband_sd");
    h_passed_rec_pt_mu_sideband_puppi        = ctx.declare_event_output<bool>("h_passed_rec_pt_mu_sideband_puppi");
    h_passed_rec_pt_mu_sideband_puppi_sd     = ctx.declare_event_output<bool>("h_passed_rec_pt_mu_sideband_puppi_sd");
    ...
    muo_tight_noniso_SF.reset(new MCMuonScaleFactor(ctx,"/nfs/dust/cms/user/skottkej/CMSSW_10_2_X_v1/CMSSW_10_2_10/src/UHH2/common/data/2016/MuonID_EfficienciesAndSF_average_RunBtoH.root","MC_NUM_TightID_DEN_genTracks_PAR_pt_eta",1, "tightID", true, MuScale_variation));
    muo_trigger_SF.reset(new MCMuonScaleFactor(ctx,"/nfs/dust/cms/user/skottkej/CMSSW_10_2_X_v1/CMSSW_10_2_10/src/UHH2/common/data/2016/MuonTrigger_EfficienciesAndSF_average_RunBtoH.root","IsoMu50_OR_IsoTkMu50_PtEtaBins",1, "muonTrigger", true, MuTrigger_variation));
    ...
    // TODO: dRSelection modified for SoftDrop!!
    if(isTTbar){
      ...
      dr_gen.reset(new dRSelection(ctx, 0.8, 0, gentopjet_col));
      dr_gen_sd.reset(new dRSelection(ctx, 0.8, 1));
      mass_gen.reset(new GenMassCompare(ctx, 0, gentopjet_col));
      mass_gen_sd.reset(new GenMassCompare(ctx, 1));
      ...
      dr_gen_sideband.reset(new dRSelection(ctx, 1.0, 0, gentopjet_col));
      dr_gen_sideband_sd.reset(new dRSelection(ctx, 1.0, 1));
    ...
    mass_sel.reset(new RecMassCompare(0));                    // 0: added 4-vector of lepton and second topjet, then compare masses; 1: same but SD
    mass_sel_sd.reset(new RecMassCompare(1));                 // 0: added 4-vector of lepton and second topjet, then compare masses; 1: same but SD
    mass_sel_puppi.reset(new PuppiMassCompare(ctx, 0));       // 0: added 4-vector of lepton and second topjet, then compare masses; 1: same but SD
    mass_sel_puppi_sd.reset(new PuppiMassCompare(ctx, 1));    // 0: added 4-vector of lepton and second topjet, then compare masses; 1: same but SD
    dr_sel.reset(new RecdRSelection(0.8));
    dr_sel_sd.reset(new RecdRSelection(0.8, 1));
    dr_sel_puppi.reset(new PuppidRSelection(ctx, 0.8));
    dr_sel_puppi_sd.reset(new PuppidRSelection(ctx, 0.8, 1));
    ...
    dr_rec_sideband_sd.reset(new RecdRSelection(1.0, 1));
    dr_rec_sideband_puppi.reset(new PuppidRSelection(ctx, 1.0));
    dr_rec_sideband_puppi_sd.reset(new PuppidRSelection(ctx, 1.0, 1));
    ...
    h_gen_pt_mu_sideband_sd.reset(new GenHists(ctx, "gen_pt_mu_sideband_sd"));
    ...
    h_muontrigger.reset(new TopSubstructureRecoHists(ctx, "muon_trigger"));
    h_muontight.reset(new TopSubstructureRecoHists(ctx, "muon_tight"));
    ...
    h_rec_pt_mu_sideband_sd.reset(new TopSubstructureRecoHists(ctx, "rec_pt_mu_sideband_sd"));
    h_rec_pt_mu_sideband_puppi.reset(new TopSubstructureRecoHists(ctx, "rec_pt_mu_sideband_puppi"));
    h_rec_pt_mu_sideband_puppi_sd.reset(new TopSubstructureRecoHists(ctx, "rec_pt_mu_sideband_puppi_sd"));
  ...
  bool PostKinCutModule::process(Event & event) {
    ...
    passed_gen_pt_mu_sideband_sd       = false;
    ...
    passed_rec_pt_mu_sideband_sd          = false;
    passed_rec_pt_mu_sideband_puppi       = false;
    passed_rec_pt_mu_sideband_puppi_sd    = false;
    ...
    if(isTTbar){
      ...
      if(passed_gen && passed_gen_pt_mu && passed_gen_pt_topjet_sd){
      ...
      if(passed_gen && passed_gen_pt_mu && passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd){
      ...
      if(passed_gen && passed_gen_pt_mu && passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd && passed_gen_dr_sd){
      ...
      if(passed_gen && passed_gen_pt_mu && passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd && passed_gen_dr_sd && passed_gen_mass_sd){
      ...
      if(passed_gen && !passed_gen_pt_mu && passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd && passed_gen_dr_sd && passed_gen_mass_sd && pt_mu_gen_sideband->passes(event)){
        if(derror) cout << "test69" << '\n';
        h_gen_pt_mu_sideband_sd->fill(event);
        if(derror) cout << "test70" << '\n';
        passed_gen_pt_mu_sideband_sd = true;
      }
      ...
      if(passed_gen && passed_gen_pt_mu && !passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd && passed_gen_dr_sd && passed_gen_mass_sd && pt_topjet_gen_sideband_sd->passes(event)){
      ...
      if(passed_gen && passed_gen_pt_mu && passed_gen_pt_topjet_sd && passed_gen_ntopjet_sd && !passed_gen_dr_sd && passed_gen_mass_sd && dr_gen_sideband_sd->passes(event)){
    ...
    */
    ...
    if(passed_rec && passed_rec_pt_mu) h_pt_mu->fill(event);
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet) h_pt_topjet->fill(event);
    if(derror) cout << "test118" << '\n';

    passed_rec_pt_topjet_sd = pt_topjet_sel_sd->passes(event);
    if(derror) cout << "test119" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_sd) h_pt_topjet_sd->fill(event);
    if(derror) cout << "test120" << '\n';

    passed_rec_pt_topjet_puppi = pt_topjet_sel_puppi->passes(event);
    if(derror) cout << "test121" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi) h_pt_topjet_puppi->fill(event);
    if(derror) cout << "test122" << '\n';

    passed_rec_pt_topjet_puppi_sd = pt_topjet_sel_puppi_sd->passes(event);
    if(derror) cout << "test123" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd) h_pt_topjet_puppi_sd->fill(event);
    if(derror) cout << "test124" << '\n';

    // >= 2 TopJets
    passed_rec_ntopjet = ntopjet2_sel->passes(event);
    if(derror) cout << "test125" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet && passed_rec_ntopjet) h_ntopjet2->fill(event);
    if(derror) cout << "test126" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_sd && passed_rec_ntopjet) h_ntopjet2_sd->fill(event);
    if(derror) cout << "test127" << '\n';

    passed_rec_ntopjet_puppi = ntopjet2_sel_puppi->passes(event);
    if(derror) cout << "test128" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi) h_ntopjet2_puppi->fill(event);
    if(derror) cout << "test129" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi) h_ntopjet2_puppi_sd->fill(event);
    if(derror) cout << "test130" << '\n';

    // dR(muon, second TopJet) < 0.8
    passed_rec_dr = dr_sel->passes(event);
    if(derror) cout << "test131" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet && passed_rec_ntopjet && passed_rec_dr) h_dr->fill(event);
    if(derror) cout << "test132" << '\n';
    passed_rec_dr_sd = dr_sel_sd->passes(event);
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_sd && passed_rec_ntopjet && passed_rec_dr_sd) h_dr_sd->fill(event);
    if(derror) cout << "test133" << '\n';

    passed_rec_dr_puppi = dr_sel_puppi->passes(event);
    if(derror) cout << "test134" << '\n';
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi && passed_rec_dr_puppi) h_dr_puppi->fill(event);
    if(derror) cout << "test135" << '\n';
    passed_rec_dr_puppi_sd = dr_sel_puppi_sd->passes(event);
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi && passed_rec_dr_puppi_sd) h_dr_puppi_sd->fill(event);
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_sd && passed_rec_ntopjet && passed_rec_dr_sd && passed_rec_mass_sd){
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi && passed_rec_dr_puppi && passed_rec_mass_puppi){
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi && passed_rec_dr_puppi_sd && passed_rec_mass_puppi_sd){
    ...
    */
    ...
    if(passed_rec && !passed_rec_pt_mu && passed_rec_pt_topjet_sd && passed_rec_ntopjet && passed_rec_dr_sd && passed_rec_mass_sd && pt_mu_rec_sideband->passes(event)){
      if(derror) cout << "test160" << '\n';
      h_rec_pt_mu_sideband_sd->fill(event);
      if(derror) cout << "test161" << '\n';
      passed_rec_pt_mu_sideband_sd = true;
    }

    if(derror) cout << "test162" << '\n';
    if(passed_rec && !passed_rec_pt_mu && passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi && passed_rec_dr_puppi && passed_rec_mass_puppi && pt_mu_rec_sideband->passes(event)){
      if(derror) cout << "test163" << '\n';
      h_rec_pt_mu_sideband_puppi->fill(event);
      if(derror) cout << "test164" << '\n';
      passed_rec_pt_mu_sideband_puppi = true;
    }

    if(derror) cout << "test165" << '\n';
    if(passed_rec && !passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi && passed_rec_dr_puppi_sd && passed_rec_mass_puppi_sd && pt_mu_rec_sideband->passes(event)){
      if(derror) cout << "test166" << '\n';
      h_rec_pt_mu_sideband_puppi_sd->fill(event);
      if(derror) cout << "test167" << '\n';
      passed_rec_pt_mu_sideband_puppi_sd = true;
    }
    ...
    if(passed_rec && passed_rec_pt_mu && !passed_rec_pt_topjet_sd && passed_rec_ntopjet && passed_rec_dr_sd && passed_rec_mass_sd && pt_topjet_rec_sideband_sd->passes(event)){
    ...
    if(passed_rec && passed_rec_pt_mu && !passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi && passed_rec_dr_puppi && passed_rec_mass_puppi && pt_topjet_rec_sideband_puppi->passes(event)){
    ...
    if(passed_rec && passed_rec_pt_mu && !passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi && passed_rec_dr_puppi_sd && passed_rec_mass_puppi_sd && pt_topjet_rec_sideband_puppi_sd->passes(event)){
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_sd && passed_rec_ntopjet && !passed_rec_dr_sd && passed_rec_mass_sd && dr_rec_sideband_sd->passes(event)){
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi && passed_rec_ntopjet_puppi && !passed_rec_dr_puppi && passed_rec_mass_puppi && dr_rec_sideband_puppi->passes(event)){
    ...
    if(passed_rec && passed_rec_pt_mu && passed_rec_pt_topjet_puppi_sd && passed_rec_ntopjet_puppi && !passed_rec_dr_puppi_sd && passed_rec_mass_puppi_sd && dr_rec_sideband_puppi_sd->passes(event)){
    ...
    event.set(h_passed_gen_pt_mu_sideband_sd, passed_gen_pt_mu_sideband_sd);
    ...
    event.set(h_passed_rec_pt_mu_sideband_sd, passed_rec_pt_mu_sideband_sd);
    event.set(h_passed_rec_pt_mu_sideband_puppi, passed_rec_pt_mu_sideband_puppi);
    event.set(h_passed_rec_pt_mu_sideband_puppi_sd, passed_rec_pt_mu_sideband_puppi_sd);
    ...
    if(!passed_rec_final&& !passed_rec_final_sd &&
      ...
      !passed_gen_pt_mu_sideband && !passed_gen_pt_mu_sideband_sd &&
      ...
      !passed_rec_pt_mu_sideband && !passed_rec_pt_mu_sideband_sd &&
      !passed_rec_pt_mu_sideband_puppi && !passed_rec_pt_mu_sideband_puppi_sd &&
