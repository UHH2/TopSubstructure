...
TopSubstructureGenHists::TopSubstructureGenHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
  ...
  if(sort_by != "sel" && sort_by != "dphimasspi"){
    book<TH1F>("M_cand1", "M_{first GenTopJet candidate} [GeV^{2}]", 40, 0, 400);
    book<TH1F>("pt_topjet_cand1", "p_{T} first GenTopJet candidate [GeV]", 120, 0, 1200);
    book<TH1F>("eta_topjet_cand1", "#eta first GenTopJet candidate", 40, -2.5, 2.5);
    book<TH1F>("Nsubjet_cand", "N_{subjets} all candidates", 4, -0.5, 3.5);
    book<TH1F>("Nsubjet_cand1", "N_{subjets} first GenTopJet candidate", 4, -0.5, 3.5);
    book<TH1F>("pt_subjet1_cand1", "p_{T}^{subjet1} first GenTopJet candidate [GeV]", 120, 0, 1200);
    book<TH1F>("pt_subjet2_cand1", "p_{T}^{subjet2} first GenTopJet candidate [GeV]", 80, 0, 800);
    book<TH1F>("m_subjet1_cand1", "M_{subjet1} first GenTopJet candidate [GeV^{2}]", 30, 0, 300);
    book<TH1F>("m_subjet2_cand1", "M_{subjet2} first GenTopJet candidate [GeV^{2}]", 30, 0, 300);
    book<TH1F>("tau1_topjet_cand1", "#tau_{1} first GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau2_topjet_cand1", "#tau_{2} first GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau3_topjet_cand1", "#tau_{3} first GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau32_cand1", "#tau_{3}/#tau_{2} first GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau21_cand1", "#tau_{2}/#tau_{1} first GenTopJet candidate", 40, 0, 1.);
    ...
    // second candidate
    book<TH1F>("M_cand2", "M_{second GenTopJet candidate} [GeV^{2}]", 40, 0, 400);
    book<TH1F>("pt_topjet_cand2", "p_{T} second GenTopJet candidate [GeV]", 120, 0, 1200);
    book<TH1F>("eta_topjet_cand2", "#eta second GenTopJet candidate", 40, -2.5, 2.5);
    book<TH1F>("Nsubjet_cand2", "N_{subjets} second GenTopJet candidate", 4, -0.5, 3.5);
    book<TH1F>("pt_subjet1_cand2", "p_{T}^{subjet1} second GenTopJet candidate [GeV]", 120, 0, 1200);
    book<TH1F>("pt_subjet2_cand2", "p_{T}^{subjet2} second GenTopJet candidate [GeV]", 80, 0, 800);
    book<TH1F>("m_subjet1_cand2", "M_{subjet1} second GenTopJet candidate [GeV^{2}]", 30, 0, 300);
    book<TH1F>("m_subjet2_cand2", "M_{subjet2} second GenTopJet candidate [GeV^{2}]", 30, 0, 300);
    book<TH1F>("tau1_topjet_cand2", "#tau_{1} second GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau2_topjet_cand2", "#tau_{2} second GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau3_topjet_cand2", "#tau_{3} second GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau32_cand2", "#tau_{3}/#tau_{2} second GenTopJet candidate", 40, 0, 1.);
    book<TH1F>("tau21_cand2", "#tau_{2}/#tau_{1} second GenTopJet candidate", 40, 0, 1.);
    ...
    book<TH1F>("dR8_top_jet", "#Delta R(top, GenTopJet) gen", 50, 0, 5.);
  }
  else{
    // first candidate
