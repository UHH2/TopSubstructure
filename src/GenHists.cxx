...
GenHists::GenHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
  ...
  book<TH1D>("M_diff1", "M_{had. GenTopJet candidate} - M_{lep. GenTopJet candidate} [GeV^{2}]", 80, -400, 400);
  book<TH1D>("M_diff2", "M_{had. GenTopJet candidate} - M_{lep. GenTopJet candidate + Muon} [GeV^{2}]", 80, -400, 400);
